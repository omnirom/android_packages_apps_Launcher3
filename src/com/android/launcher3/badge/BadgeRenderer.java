...
public class BadgeRenderer {
    ...
    private final DeviceProfile mLauncher;
    ...
    public BadgeRenderer(Context context, int iconSizePx, DeviceProfile launcher) {
        mContext = context;
        mLauncher = launcher;
    ...
    public void draw(Canvas canvas, IconPalette palette, @Nullable BadgeInfo badgeInfo,
        ...
        final boolean dotsOnly = isShowDotsOnly();
    ...
    private boolean isShowDotsOnly() {
        return !mLauncher.isShowNotificationDotNumbers();
    }
