...
public class Launcher extends BaseActivity
    ...
    private void setupViews() {
        ...
        mCalendarView = (CalendarView) mTopContainer.findViewById(R.id.calendar_view);
        mWeatherView = (CurrentWeatherView) mTopContainer.findViewById(R.id.current_weather_view);
    ...
    public void requestCalendarPermission() {                
        requestPermissions(new String[]{Manifest.permission.READ_CONTACTS, Manifest.permission.READ_CALENDAR,
